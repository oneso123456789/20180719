...
// @Pointcut("execution(* com.javalec.ex.*.*())")	// com.javalec.ex. 패키지에 파라미터가없는 모든 메소드
...
// @Pointcut("within(com.javalec.ex.*)")		//com.javalec.ex 패키지 안에 있는 모든메소드
...
// @Pointcut("bean(student)")		//student빈에만 적용
